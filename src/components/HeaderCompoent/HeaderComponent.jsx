...
import honeylogo from "../../assets/images/honeylogo.webp"
...
const HeaderComponent = ({ isHiddenSearch = false, isHiddenCart = false }) => {
    ...
    return (
    <div style={{ width: '100%', background: '#fdc215', display: 'flex', justifyContent: 'center'}}>
        <WrapperHeader style={{ justifyContent: isHiddenSearch && isHiddenSearch ? 'space-between' : 'unset' }}>
        <Col span={5}>
            <WrapperTextHeader to = '/'><img src={honeylogo} style={{width: '200px', height: '55px'}}/></WrapperTextHeader>
