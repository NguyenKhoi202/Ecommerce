                ...
                {order?.orderItems?.map((order) => {
                  ...
                  <WrapperItemOrder key={order?.product}>
                    ...
                    <WrapperCountOrder>
                      ...
                      <span style={{color: '#000', fontSize: '13px', fontWeight: 500}}>{convertPrice(order?.price * order?.amount)}</span>
            ...
            <div style={{width: '100%'}}>
              ...
              <WrapperInfo>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                    ...
                    <span style={{ color: '#000', fontSize: '14px', fontWeight: 500}}>{convertPrice(diliveryPriceMemo)} </span>
                </div>
                </WrapperInfo>
                <WrapperTotal>
                <span>Tổng tiền</span>
                <span style={{display:'flex', flexDirection: 'column'}}>
                  <span style={{color: '#000', fontSize: '24px', fontWeight: 'bold'}}>{convertPrice(totalPriceMemo)}</span>
